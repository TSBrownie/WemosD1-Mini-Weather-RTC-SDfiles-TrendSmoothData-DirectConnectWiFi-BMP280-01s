...
//WiFi Viewing, RTC, SD File: Absolute Barometric Pressure (SL & Comp), Temp, no humidity
...
//UNUSED: Wemos Vdd/GND-->BMP280=SDO(Addr control), Wemos Vdd/GND-->BMP280=CSB(I2C select, GND=SPI)
...
//20220208 - TSBrownie.  Non-commercial use.
...
#define BMP280Addr 0x76              //I2C addr BMP280 I2C 0x76(108), or 0x77
